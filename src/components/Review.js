...
<div className="review-container">
    ...
    <ul className="hash-list cols-3 cols-1-xs pad-30-all align-center text-sm">
        <li>
          ...
          <p className="fs-110 font-cond-l" contenteditable="false">"This Indian Ghats website is a gem! The detailed information about various ghats, along with stunning visuals, made my virtual exploration an enriching experience."</p>
        ...
        <li>
          ...
          <p className="fs-110 font-cond-l" contenteditable="false">" The Indian Ghats website is a great starting point for anyone interested in understanding the beauty and spirituality of India's ghats. The visuals are breathtaking, and the site provides valuable insights into the rituals and traditions associated with each ghat. "</p>
        ...
        <li>
          ...
          <p className="fs-110 font-cond-l" contenteditable="false">"As a history enthusiast, I was impressed by the depth of historical information presented on this Indian Ghats website. The narratives accompanying each ghat's description are well-researched and captivating."</p>
